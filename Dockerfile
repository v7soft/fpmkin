...
DEBIAN_FRONTEND='noninteractive' apt-get -y install php-db php-pear php5-curl php5-fpm php5-gd php5-interbase php5-mcrypt php5-memcache php5-mysql php5-odbc php5-sybase php5-xcache && \
sed -i "s/;date.timezone =.*/date.timezone = Novosibirsk\/Asia/; s/;cgi.fix_pathinfo=1/cgi.fix_pathinfo=0/; s/short_open_tag/;short_open_tag/" /etc/php5/fpm/php.ini && \
